    ...
    <div className="mx-auto max-w-6xl px-6 py-10">
      <header className="mb-6">
        ...
        <p className="mt-2 max-w-3xl text-pampa-muted">
          Você descobriu a falha sem precisar desta página — só observando o
          tráfego HTTP. Em projetos reais, porém,{" "}
          <strong>esta é a primeira coisa que um dev ou pentester abre</strong>:
          a documentação OpenAPI lista cada rota, cada campo, cada resposta. É
          o complemento que torna o trabalho rápido.
        </p>
      </header>

      <section
        aria-label="Lembrete de métodos HTTP"
